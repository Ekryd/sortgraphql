...
public class SchemaPrinter {
    ...
    public static class Options {
        ...
        private Options(boolean includeIntrospectionTypes,
                        ...
                        boolean includeDefinedDirectiveDefinitions, boolean useAstDefinitions,
        ...
        public Options includeIntrospectionTypes(boolean flag) {
            return new Options(flag, this.includeScalars, this.includeSchemaDefinition, this.includeDirectiveDefinitions, this.includeDefinedDirectiveDefinitions, this.useAstDefinitions, this.descriptionsAsHashComments, this.includeDirective, this.includeSchemaElement, this.comparatorRegistry);
        }
        ...
        public Options includeScalarTypes(boolean flag) {
            return new Options(this.includeIntrospectionTypes, flag, this.includeSchemaDefinition, this.includeDirectiveDefinitions, this.includeDefinedDirectiveDefinitions, this.useAstDefinitions, this.descriptionsAsHashComments, this.includeDirective, this.includeSchemaElement, this.comparatorRegistry);
        }
        ...
        public Options includeSchemaDefinition(boolean flag) {
            return new Options(this.includeIntrospectionTypes, this.includeScalars, flag, this.includeDirectiveDefinitions, this.includeDefinedDirectiveDefinitions, this.useAstDefinitions, this.descriptionsAsHashComments, this.includeDirective, this.includeSchemaElement, this.comparatorRegistry);
        }
        ...
        public Options includeDirectiveDefinitions(boolean flag) {
            return new Options(this.includeIntrospectionTypes, this.includeScalars, this.includeSchemaDefinition, flag, this.includeDefinedDirectiveDefinitions, this.useAstDefinitions, this.descriptionsAsHashComments, this.includeDirective, this.includeSchemaElement, this.comparatorRegistry);
        }

        /**
         * This flag controls whether schema printer will include non-standard directive definitions at the top of the schema, but does not remove them from the field or type usage.
         * <p>
         * In some schema defintions, like Apollo Federation, the schema should be printed without the directive definitions.
         * This simplified schema is returned by a GraphQL query to other services, in a format that is different that the introspection query.
         * <p>
        ...
        public Options includeDefinedDirectiveDefinitions(boolean flag) {
            return new Options(this.includeIntrospectionTypes, this.includeScalars, this.includeSchemaDefinition, this.includeDirectiveDefinitions, flag, this.useAstDefinitions, this.descriptionsAsHashComments, this.includeDirective, this.includeSchemaElement, this.comparatorRegistry);
        }
        ...
        public Options includeDirectives(boolean flag) {
            return new Options(this.includeIntrospectionTypes, this.includeScalars, this.includeSchemaDefinition, this.includeDirectiveDefinitions, this.includeDefinedDirectiveDefinitions, this.useAstDefinitions, this.descriptionsAsHashComments, directive -> flag, this.includeSchemaElement, this.comparatorRegistry);
        }
        ...
        public Options includeDirectives(Predicate<GraphQLDirective> includeDirective) {
            return new Options(this.includeIntrospectionTypes, this.includeScalars, this.includeSchemaDefinition, this.includeDirectiveDefinitions, this.includeDefinedDirectiveDefinitions, this.useAstDefinitions, this.descriptionsAsHashComments, includeDirective, this.includeSchemaElement, this.comparatorRegistry);
        }
        ...
        public Options includeSchemaElement(Predicate<GraphQLSchemaElement> includeSchemaElement) {
            ...
            return new Options(this.includeIntrospectionTypes, this.includeScalars, this.includeSchemaDefinition, this.includeDirectiveDefinitions, this.includeDefinedDirectiveDefinitions, this.useAstDefinitions, this.descriptionsAsHashComments, includeDirective, includeSchemaElement, this.comparatorRegistry);
        }
        ...
        public Options useAstDefinitions(boolean flag) {
            return new Options(this.includeIntrospectionTypes, this.includeScalars, this.includeSchemaDefinition, this.includeDirectiveDefinitions, this.includeDefinedDirectiveDefinitions, flag, this.descriptionsAsHashComments, this.includeDirective, this.includeSchemaElement, this.comparatorRegistry);
        }
        ...
        public Options descriptionsAsHashComments(boolean flag) {
            return new Options(this.includeIntrospectionTypes, this.includeScalars, this.includeSchemaDefinition, this.includeDirectiveDefinitions, this.includeDefinedDirectiveDefinitions, this.useAstDefinitions, flag, this.includeDirective, this.includeSchemaElement, this.comparatorRegistry);
        }
        ...
        public Options setComparators(GraphqlTypeComparatorRegistry comparatorRegistry) {
            return new Options(this.includeIntrospectionTypes, this.includeScalars, this.includeSchemaDefinition, this.includeDirectiveDefinitions, this.includeDefinedDirectiveDefinitions, this.useAstDefinitions, this.descriptionsAsHashComments, this.includeDirective, this.includeSchemaElement, comparatorRegistry);
        }
    }
    ...
    public String print(GraphQLSchema schema) {
        ...
        List<GraphQLNamedType> typesAsList = schema.getAllTypesAsList()
                .stream()
                .sorted(Comparator.comparing(GraphQLNamedType::getName))
                .collect(toCollection(ArrayList::new));

        typesAsList = removeMatchingItems(typesAsList, matchesName("Query"), printType(out, visibility));
        typesAsList = removeMatchingItems(typesAsList, matchesName("Mutation"), printType(out, visibility));
        typesAsList = removeMatchingItems(typesAsList, matchesName("Subscription"), printType(out, visibility));

        typesAsList = removeMatchingItems(typesAsList, matchesClass(GraphQLScalarType.class), printType(out, visibility));
        typesAsList = removeMatchingItems(typesAsList, matchesClass(GraphQLInterfaceType.class), printType(out, visibility));
        typesAsList = removeMatchingItems(typesAsList, matchesClass(GraphQLUnionType.class), printType(out, visibility));
        typesAsList = removeMatchingItems(typesAsList, matchesClass(GraphQLInputObjectType.class), printType(out, visibility));
        typesAsList = removeMatchingItems(typesAsList, matchesClass(GraphQLObjectType.class), printType(out, visibility));
        typesAsList.stream().filter(matchesClass(GraphQLEnumType.class)).forEach(printType(out, visibility));
    ...
    private Predicate<GraphQLNamedType> matchesClass(Class<?> clazz) {
        return type -> clazz.isAssignableFrom(type.getClass()) && options.getIncludeSchemaElement().test(type);
    }
    ...
    private <T> List<T> removeMatchingItems(List<T> list, Predicate<T> filter, Consumer<T> removedItemsFn) {
        if (list.isEmpty()) {
            return list;
        }
    ...
    private void printType(PrintWriter out, ArrayList<GraphQLNamedType> typesAsList, String name, GraphqlFieldVisibility visibility) {
        ...
        return (out, type, visibility) -> {
            ...
            if (shouldPrintAsAst(type.getDefinition())) {
                ...
                if (type.getInterfaces().isEmpty()) {
                    out.format("interface %s%s", type.getName(), type.getDirectives().isEmpty() ? " " : directivesString(GraphQLInterfaceType.class, type.getDirectives()));
                } else {
                    ...
                    out.format("interface %s implements %s%s",
                            ...
                            type.getDirectives().isEmpty() ? " " : directivesString(GraphQLInterfaceType.class, type.getDirectives()));
                }
    ...
    private TypePrinter<GraphQLObjectType> objectPrinter() {
        return (out, type, visibility) -> {
            ...
            if (shouldPrintAsAst(type.getDefinition())) {
                ...
                printComments(out, type, "");
                if (type.getInterfaces().isEmpty()) {
                    out.format("type %s%s", type.getName(), type.getDirectives().isEmpty() ? " " : directivesString(GraphQLObjectType.class, type.getDirectives()));
                } else {
                    ...
                    out.format("type %s implements %s%s",
                            type.getName(),
                            interfaceNames.collect(joining(" & ")),
                            type.getDirectives().isEmpty() ? " " : directivesString(GraphQLObjectType.class, type.getDirectives()));
                }
    ...
    private TypePrinter<GraphQLSchema> schemaPrinter() {
        return (out, schema, visibility) -> {
            ...
            if (options.isIncludeDirectiveDefinitions()) {
                ...
                List<GraphQLDirective> directives = getSchemaDirectives(schema).stream()
                        .filter(directive -> directive.getDefinition() != null && directive.getDefinition().getSourceLocation() != null)
