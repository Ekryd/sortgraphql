...
sorted2 = new File(basedir, 'src/main/resources/wolfExtend.graphqls')
expected2 = new File(basedir, 'wolfExtend_expected.graphqls')
backup2 = new File(basedir, 'src/main/resources/wolfExtend.graphqls.bak')
